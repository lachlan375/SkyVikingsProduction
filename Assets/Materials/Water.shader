...
Shader "Custom/Water" {
	...
	//#pragma surface surf Standard fullforwardshadows //Physically based standard lighting model, enable shadows on all light types
	//#pragma target 3.0 //Nicer lighting
